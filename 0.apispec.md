...
Access the “APIs” tile from the main menu, and then select “API Model and Mock”.
...
You can import the same from filesystem as below.
...
Please Click on "Generate Schema from Sample Data" and hit  "Continue".

<img src="/images/apispec/11.png" alt="APIIMP" width=400/>

*On the next screen please copy paste this sample payload and hit "Generate Schema"*
...
Enter a name for InputSchema and hit Save
...
As we did earlier for the request, make sure to name the generated schema for reusability (ex. ShipmentWaiverOutput):

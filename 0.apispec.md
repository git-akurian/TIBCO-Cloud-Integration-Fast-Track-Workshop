...
1) Download ad the save the apisec locally from the URL
`https://github.com/git-akurian/TIBCO-Cloud-Integration-Virtual-Workshop/blob/master/project/apispecs/shipmentwaiver-tci-wkshop-1.json`

...
Please enter "ShipmentWaiverInput" for a name and type in a simple json schema
...
This time we will input the payload rather than entering a Schema. Copy the sample sample payload as shown from below, and click on Generate Schema.

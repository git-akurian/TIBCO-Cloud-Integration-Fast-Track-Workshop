...
OR, alternatively, you can skip these configuration steps and import the completed API spec from a file.

Jump to the [Import the Completed API Spec](./0.apispec.md#consolidated-api-specs-needed-for-this-workshop) section below.

...
3.	Expand Activity Input flowInputs->Customer->loginId. Enter ‘Your email id’ into flowInputs. Use double quotes as shown to encapsulate your email id. (Because the input field is of type string)

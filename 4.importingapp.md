...
<img src="/images/appimp/7.1.png" alt="appimp" width=500/>

and check the host & password details previously shared for the "CRMDB" and hit Connect.

<img src="/images/appimp/7.2.png" alt="appimp" width=500/>

Once the connection is good,Click inside the query section, and add a space in the end(this will re-enable the 'Save' option) allowing for the flow activity to connect back to 'mysql connection', this time without an error > Save and Close.

...
<img src="/images/mockapp/1.png" alt="Close Prompt" width=700/>
...
<img src="/images/mockapp/3.png" alt="Close Prompt" width=700/>

Scroll down to the sample payload and click try it out:

<img src="/images/mockapp/4.png" alt="Close Prompt" width=700/>

Notice the successful return code and sample data. Your Mock app is ready for testing by your developers:

<img src="/images/mockapp/5.png" alt="Close Prompt" width=700/>

...
Post completion of Shipment Waiver application, we can now expose this as an API. In other words, we will now push our Flogo App (created from the API Specification) to 'Mashery' which will provide secure access to your API.

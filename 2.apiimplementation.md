...
Please open the 'crmdbconnection' file which contains the connection details.

*/Note: In your downloaded git repository, this file will be at the location /TIBCO-Cloud-Integration-Virtual-Workshop/labfiles/flogoapp/crmdbconnection.md

If you have not downloaded the complete repo, here is the individual file location - 'https://raw.githubusercontent.com/git-akurian/TIBCO-Cloud-Integration-Virtual-Workshop/master/labfiles/flogoapp/crmdbconnection.md'
/*

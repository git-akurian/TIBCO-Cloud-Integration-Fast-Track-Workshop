...
Please get the connection details from the file - 'https://github.com/git-akurian/TIBCO-Cloud-Integration-Virtual-Workshop/blob/master/labfiles/flogoapp/crmdbconnection.md'

From the Menu Choose Connections > then add connection > enter mysql to find connector :
<img src="/images/apiimp/11.png" alt="APIIMP" width=850/>

Clicking on Connection and enter the details given by your instructor > Hit Connect :
<img src="/images/apiimp/12.png" alt="APIIMP" width=500/>

A connection will be successfully added as below:
<img src="/images/apiimp/13.png" alt="APIIMP" width=700/>
...
<img src="/images/apiimp/1.png" alt="APIIMP" width=700/>
...
<img src="/images/apiimp/7png" alt="APIIMP" width=700/>

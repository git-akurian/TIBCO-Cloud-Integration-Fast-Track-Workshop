...
### Note: The next step (of Exposing the URL to an API Gateway) is an optional step if participants are using one of the below regions.
#### TCI in Europe [TIBCO Cloud Region as "Ireland" ]
#### OR
#### TCI in Australia [Cloud Region as "Sydney"] 

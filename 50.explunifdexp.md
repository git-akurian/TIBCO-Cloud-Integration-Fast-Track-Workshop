...
Let's take a look at how can we expose Our App end-point to an API Gateway. It's an optional capability  to cover for your application/workshop. 

####Note: TIBCO Cloud - API Gateway Service [Mashery] is not available in all the regions. If you are using TCI in Europe [TIBCO Cloud Region as "Ireland" ] Or Australia [Cloud Region as "Sydney"]  consider this as a logical ending of workshop.  

...
5. The app will be  imported and Click on the imported app to build on the flow.

<img src="/images/appimp/6.png" alt="appimp" width=700/>

6. The flow will be opened and notice the errors with some of the activities.

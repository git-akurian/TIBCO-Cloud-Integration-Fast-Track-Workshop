# What is a Low Code Business App in TCI
The next step will be to enable a Business Personnel to have the ability to 'Approve' or 'Deny' a shipping waiver. In this case, the step is automated.
...
In other words, the microservice (built in Flogo) will be able to to reach out to a business process (built in LiveApps) to complete our 'ShipmentWaiverApp'

Here is how the **LiveApps** capabilities of 'Low Code Apps and Processes' are laid out in TCI.
<img src="/images/laactivate/17.png" alt="laactivate" width=700/>

User's can navigate to the Designer section of the LiveApps to view the process they have imported and activated after following the below steps.
